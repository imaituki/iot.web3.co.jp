<?php /* Smarty version Smarty-3.1.18, created on 2019-10-28 11:30:40
         compiled from "../template/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4441767155db652d0e38c07-40378521%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '4441767155db652d0e38c07-40378521',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5db652d0f11f14_64750332',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5db652d0f11f14_64750332')) {function content_5db652d0f11f14_64750332($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
...
<div id="wrapper">
	<?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['template_secondary']->value, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('action'=>"blog",'manage'=>((string)$_smarty_tpl->tpl_vars['_CONTENTS_DIR']->value)), 0);?>
					...
					<form method="post" action="" id="formSearch" enctype="multipart/form-data">
						<div class="col-sm-4">
							...
							<div class="input-group">
								<input type="text" id="search_keyword" name="search_keyword" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['_SESSION']->value['admin']['blog_category']['search']['POST']['search_keyword'])===null||$tmp==='' ? '' : $tmp);?>

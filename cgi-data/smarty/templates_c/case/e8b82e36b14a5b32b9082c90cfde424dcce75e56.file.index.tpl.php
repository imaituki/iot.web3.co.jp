<?php /* Smarty version Smarty-3.1.18, created on 2019-11-29 15:10:11
...
<?php if ($_valid && !is_callable('content_5dc152baa27281_88847372')) {function content_5dc152baa27281_88847372($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/virtual/119.245.151.134/data/smarty/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="utf-8">
...
/"><i class="fa fa-home"></i></a></li>
				<?php if ($_smarty_tpl->tpl_vars['arr_get']->value['cid']) {?><li><a href="./">運行例</a></li><li><?php echo $_smarty_tpl->tpl_vars['OptionCaseCategory']->value[$_smarty_tpl->tpl_vars['arr_get']->value['cid']];?>
</li>
				<?php } else { ?><li>運行例</li><?php }?>
			</ul>
		</div>
	</div>
	<section>

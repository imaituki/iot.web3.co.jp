 ...
 * キーワード検索履歴
 */
$package_name = 'keyword_search_result';
$config["{$package_name}_package_name_label"] = 'キーワード検索履歴';	//親のデータ種別。デフォルトはブランク
...
$config["{$package_name}_max_list"] = 50;
...
$config["{$package_name}_label_keyword_search_condition"] = 'キーワード';
...
$config["{$package_name}_label_post_title"] = 'キーワード';

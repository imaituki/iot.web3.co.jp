 ...
 * 固定ページ
 */
$package_name = 'freetext';
$config["{$package_name}_package_name_label"] = '固定ページ';
...
$config["{$package_name}_label_basic_category"] = 'ページ種別';
$config["{$package_name}_use_image_upload"] = FALSE;
$config["{$package_name}_use_doc_upload"] = FALSE;
$config["{$package_name}_max_image_file"] = 3;
...
$config["{$package_name}_validate_rule_basic_category"] = '';
...
$config["{$package_name}_validate_rule_post_content"] = 'trim|required|max_length[10000]';

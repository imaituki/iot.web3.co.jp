 ...
 */
$package_name = 'info';
$config["{$package_name}_package_name_label"] = 'お知らせ';	//親のデータ種別。デフォルトはブランク
...
$config["{$package_name}_use_doc_upload"] = TRUE;
$config["{$package_name}_max_image_file"] = 4;
$config["{$package_name}_max_doc_file"] = 2;
$config["{$package_name}_use_image_caption"] = TRUE;
...
$config["{$package_name}_column_new_icon_end_date_use"] = TRUE;
...
$config["{$package_name}_column_post_link_text_use"] = TRUE;
...
$config["{$package_name}_label_post_sub_title"] = 'タイトル2';

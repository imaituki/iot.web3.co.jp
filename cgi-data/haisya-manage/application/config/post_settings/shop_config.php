 ...
 */
$package_name = 'shop';
$config["{$package_name}_package_name_label"] = '店舗';	//親のデータ種別。デフォルトはブランク
...
$config["{$package_name}_thumbnail_height"] = 160;
$config["{$package_name}_thumbnail_m_width"] = FALSE;
$config["{$package_name}_thumbnail_m_height"] = FALSE;
$config["{$package_name}_thumbnail_ss_width"] = FALSE;
$config["{$package_name}_thumbnail_ss_height"] = FALSE;
...
$config["{$package_name}_column_post_link_use"] = TRUE;
$config["{$package_name}_column_post_link_text_use"] = FALSE;
$config["{$package_name}_column_order_number_use"] = FALSE;
$config["{$package_name}_label_keyword_search_condition"] = '企業名・店名';
...
$config["{$package_name}_label_post_title"] = '企業名・店名';
$config["{$package_name}_label_post_content"] = 'PR文';
$config["{$package_name}_label_post_sub_title"] = '支店名';
$config["{$package_name}_label_post_link"] = 'URL';
$config["{$package_name}_label_post_link_text"] = 'リンク用テキスト';
$config["{$package_name}_label_order_number"] = 'ソート優先';

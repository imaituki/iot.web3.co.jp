 ...
 */
$package_name = 'member';
$config["{$package_name}_package_name_label"] = '会員';	//親のデータ種別。デフォルトはブランク
...
$config["{$package_name}_label_keyword_search_condition"] = '氏名';
...
$config["{$package_name}_label_post_title"] = '氏名';
$config["{$package_name}_label_post_content"] = '通信欄';

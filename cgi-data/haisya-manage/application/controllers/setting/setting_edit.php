 ...
 *
 */
class Setting_edit extends Post_register_Controller 
{
	...
	protected function _convert_load_data()
	{
		...
		$this->data[self::F_SPECIAL_START_DATE] = format_date_to_pattern($this->target_entity->special_start_date, "Y/m/d");
		$this->data[self::F_SPECIAL_END_DATE] = format_date_to_pattern($this->target_entity->special_end_date, "Y/m/d");
	}

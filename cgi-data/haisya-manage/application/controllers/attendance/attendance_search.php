 ...
 *
 */
class Attendance_search extends Search_Controller 
{
	/** フォームで使用するパラメータ名 */
	const F_COND_USER_NAME = 'cond_user_name';
	const F_COND_USER_FURIGANA = 'cond_user_furigana';
	const F_COND_DATE = 'cond_date';
	...
	public function __construct()
	{
		...
		$this->delete_model = $this->T_attendance;
		$this->_page_setting();
	...
	{
		//検索に必要な情報を作成
		$params = $this->_get_attendance_condition_params();
	 ...
	 */
	private function _get_attendance_condition_params()
	{
		$params = array();
		$params['user_name'] =  $this->data[self::F_COND_USER_NAME];
		$params['user_furigana'] =  $this->data[self::F_COND_USER_FURIGANA];
		$params['date'] =  $this->data[self::F_COND_DATE];

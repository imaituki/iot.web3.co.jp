 ...
 *
 */
class Ndssample_search extends Post_search_Controller 
{
	/*
	 * コンストラクタ
	 */
	public function __construct()
	{
		...
		$this->target_data_type = Relation_data_type::NDSSAMPLE;
		$this->package_name = 'ndssample';
		...
		$this->main_model = $this->T_ndssample;
		$this->sub_model = FALSE;
		$this->delete_model = $this->T_ndssample;
		$this->_page_setting();

 ...
 *
 */
class Car_class_register extends Register_Controller
{
	/** フォームで使用するパラメータ名 */
	...
	private function _relation_check()
	{
		...
		if ($this->M_car_class->is_car_class_name_exists($this->data[self::F_CAR_CLASS_NAME]))
		{
			$ret = FALSE;

 ...
 *
 */
class Car_class_search extends Search_Controller 
{
	/** フォームで使用するパラメータ名 */
	const F_COND_CAR_CLASS_NAME = 'cond_car_class_name';
	...
	public function __construct()
	{
		...
		$this->delete_model = $this->M_car_class;
		$this->_page_setting();
	...
	{
		$params = array();
		$params['car_class_name'] =  $this->data[self::F_COND_CAR_CLASS_NAME];

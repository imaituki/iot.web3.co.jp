 ...
 *
 */
class Customer_register extends Register_Controller
{
	/** フォームで使用するパラメータ名 */
	...
	private function _input_check()
	{
		...
		$this->form_validation->set_rules(self::F_EMAIL, 'メールアドレス', 'trim|max_length[50]');
	...
	private function _relation_check()
	{
		...
		if ($this->M_customer->is_customer_exists($this->data[self::F_COMPANY_NAME]))
		{
			$ret = FALSE;

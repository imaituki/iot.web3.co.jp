 ...
 *
 */
class Car_profile_search extends Search_Controller 
{
	/** フォームで使用するパラメータ名 */
	const F_COND_NUMBER_PLATE = 'cond_number_plate';
	const F_COND_REGISTRATION_NUMBER = 'cond_registration_number';
	...
	public function __construct()
	{
		...
		$this->delete_model = $this->M_car_profile;
		$this->_page_setting();
	...
	{
		//検索に必要な情報を作成
		$params = $this->_get_car_condition_params();
	 ...
	 */
	private function _get_car_condition_params()
	{
		$params = array();
		$params['number_plate'] =  $this->data[self::F_COND_NUMBER_PLATE];
		$params['registration_number'] =  $this->data[self::F_COND_REGISTRATION_NUMBER];

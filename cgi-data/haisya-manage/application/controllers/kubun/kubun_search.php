...
class Kubun_search extends Search_Controller 
{
	...
	public function __construct()
	{
		...
		//独自のソート順
		$this->first_sort_key = 'relation_data_type';
		$this->first_sort_order = 'ASC';
		$this->second_sort_key = 'kubun_type';
		$this->second_sort_order = 'ASC';
		$this->third_sort_key = 'parent_kubun_id';
		$this->third_sort_order = 'ASC';
		$this->fourth_sort_key = 'kubun_code';
		$this->fourth_sort_order = 'ASC';

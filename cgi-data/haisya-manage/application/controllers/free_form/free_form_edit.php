 ...
 *
 */
class Free_form_edit extends Post_register_Controller 
{
	...
	public function index($post_id)
	{
		...
		$this->_load_form_item($post_id, Mail_form_type::BASIC);
		$this->_load_form_item($post_id, Mail_form_type::OPTION);
	...
	private function _do_db_logic()
	{
		...
		$this->_delete_form_item($post_id);
	 ...
	 */
	private function _delete_form_item($free_form_id)
	{
		$params = array(
		...
		$this->T_free_form_item->delete_by_params($params);
	}

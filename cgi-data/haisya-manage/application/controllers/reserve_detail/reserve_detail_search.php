 ...
 *
 */
class Reserve_detail_search extends Search_Controller 
{
	/** フォームで使用するパラメータ名 */
	...
	public function __construct()
	{
		...
		$this->delete_model = $this->T_reserve_detail;
	...
	function delete($id = '')
	{
		...
		$this->_save_page_session(parent::SESSION_KEY_INPUT_DATA, $this->data);

		/*
		 * 削除処理
		 */
		$this->db->trans_start();
		$this->T_reserve_detail->delete($id);
		//$this->T_reserve_detail->logical_delete($id);

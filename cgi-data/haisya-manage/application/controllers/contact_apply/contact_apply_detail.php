 ...
 *
 */
class Contact_apply_detail extends Post_register_Controller 
{
	const FREE_FORM_ID = 'free_form';
	 ...
	 */
	public function index($free_form_id, $apply_id)
	{
		/*
		 * 初期処理
		 */
		...
		$this->_load_form_item($free_form_id, Mail_form_type::BASIC);
		$this->_load_form_item($free_form_id, Mail_form_type::OPTION);

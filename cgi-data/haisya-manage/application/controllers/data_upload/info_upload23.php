 ...
 *
 */
class Info_upload23 extends Register_Controller
{
	var $csv_file_relative_path = "/controllers/data_upload/csv/23.csv";
	...
	public function __construct()
	{
		...
		$this->common_h3_tag = "23お知らせの一括登録";
	...
	function index()
	{
		$this->_load_tpl("data_upload/info_upload23_input_view", $this->data);
	}
	...
	private function _insert_shop($line)
	{
		...
		$entity->post_date = create_db_datetme_str(date('Y/m/d', strtotime ('-1 year')));

 ...
 *
 */
class Info_upload extends Register_Controller
{
	var $csv_file_relative_path = "/controllers/data_upload/csv/24.csv";
	...
	function index()
	{
		$this->_load_tpl("data_upload/info_upload_input_view", $this->data);
	}

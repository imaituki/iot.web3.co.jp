 ...
 *
 */
class Keyword_search_result_search extends Post_search_Controller 
{
	/*
	 * コンストラクタ
	 */
	public function __construct()
	{
		...
		$this->target_data_type = Relation_data_type::KEYWORD_SEARCH_RESULT;
		$this->package_name = 'keyword_search_result';
		...
		$this->main_model = $this->T_keyword_search_result;
		$this->sub_model = FALSE;
		$this->delete_model = $this->T_keyword_search_result;
		$this->_page_setting();
		...
		//独自のソート順
		$this->first_sort_key = 'last_update_datetime';

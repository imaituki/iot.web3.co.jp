 ...
 *
 */
class Disposal_search extends Search_Controller 
{
	/** フォームで使用するパラメータ名 */
	const F_COND_DISPOSAL_NAME = 'cond_disposal_name';
	const F_COND_DISPOSAL_FURIGANA = 'cond_disposal_furigana';
	...
	public function __construct()
	{
		...
		$this->delete_model = $this->M_disposal;
		$this->_page_setting();
		...
		//独自のソート順
		$this->first_sort_key = 'disposal_furigana';
	...
	{
		//検索に必要な情報を作成
		$params = $this->_get_disposal_condition_params();
	 ...
	 */
	private function _get_disposal_condition_params()
	{
		$params = array();
		$params['disposal_name'] =  $this->data[self::F_COND_DISPOSAL_NAME];
		$params['disposal_furigana'] =  $this->data[self::F_COND_DISPOSAL_FURIGANA];

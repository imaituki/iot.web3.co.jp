...
<tr>
	...
	<th>送信先メールアドレス2</th>
	<td>
		<?php echo h($to_email_2); ?>
	</td>
</tr><tr>
	<th>送信元メールアドレス</th>
	<td>
		<?php echo h($from_email); ?>
	</td>
</tr><tr>
	<th>差出人</th>
	<td>
		<?php echo h($from_label); ?>
	</td>
</tr><tr>
	<th>メール件名</th>
	<td>
		<?php echo h($mail_subject); ?>
	</td>
</tr><tr>
	<th>確認メール用メッセージ</th>
	<td>
		<?php echo h_br($confirm_message); ?>
	</td>
</tr><tr>
	<th>署名</th>
	<td>
		<?php echo h_br($mail_signature); ?>
	</td>
</tr>
	<!-- 追加項目セット位置 -->
</tbody>
...
<table class="table table-bordered" id="mail_form_detail_table">
<thead>
	<tr>
		<th colspan="4" class="table_section">問い合わせフォーム基本項目</th>
	</tr>
	<tr>
		<th class="span3">項目名</th>
		<th class="">必須</th>
		<th class="span3">使用有無</th>
		<th>詳細</th>
	</tr>
</thead>
<tbody>
	...
	<tr>
		<td>
			<span class="label label-info"><?php echo Mail_form_column::get_basic_label($column_no); ?></span><br />
			<?php echo h($this->data[$title_key]); ?>
		</td>
		<td>
			<?php echo ($this->data[$require_flg_key] == Valid_flg::VALID) ? '必須' : ''; ?>
		</td>
		<td>
			<?php echo Form_type::get_basic_label($this->data[$form_type_key]); ?>
		</td>
		<td>
...
<table class="table table-bordered" id="mail_form_detail_optional_table">
<thead>
	<tr>
		<th colspan="4" class="table_section">問い合わせフォーム追加項目</th>
	</tr>
	<tr>
		<th class="span3">項目名</th>
		<th class="">必須</th>
		<th class="span3">種類</th>
		<th>選択肢（選択項目の場合に使用）</th>
	</tr>
</thead>
<tbody>
	...
	<tr style="">
		...
		<td>
			<?php echo Form_type::get_label($this->data[$form_type_key]); ?>
		</td>
		<td>
			<?php echo h($this->label_list[$coices_key]); ?>
		</td>
	</tr>
	<?php endforeach; ?>
</tbody>

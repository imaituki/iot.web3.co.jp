...
<tr>
	<th>年度</th>
	<td>
		<?php echo h($this->label_list['annual']); ?>&nbsp;
	</td>
</tr>
</tbody>
</table>
...
<tbody>
	...
	<?php endif; ?>
	<tr>
		<th class="span3">リンク2</th>
		<td>
			<span class="label" style="vertical-align:baseline;">URL</span>　<?php echo h($post_link2); ?><br />
			<span class="label" style="vertical-align:baseline;">リンク用テキスト</span>　<?php echo h($post_link_text2); ?>
		</td>
	</tr>
	<tr>
		<th class="span3">リンク3</th>
		<td>
			<span class="label" style="vertical-align:baseline;">URL</span>　<?php echo h($post_link3); ?><br />
			<span class="label" style="vertical-align:baseline;">リンク用テキスト</span>　<?php echo h($post_link_text3); ?>
		</td>
	</tr>
</tbody>
</table>
...
<tr>
	<th>募集有無</th>
	<td>
		<?php echo h($event_accept_flg); ?>
		<?php echo ($event_accept_flg === Valid_flg::VALID) ? '募集する' : '募集しない'; ?>&nbsp;
	</td>
</tr>
<tr>
	<th>申し込み締め切り日</th>
	<td>
		<?php echo h($event_accept_end_date); ?>
	</td>
</tr>
<tr>
	<th class="span3">申し込みフォーム</th>
	<td>
		<?php echo h($this->label_list['free_form_id']); ?>
	</td>
</tr>
<tr>
	<th>開催日</th>
	<td>
		<?php echo h($event_start_date); ?>
	</td>
</tr><tr>
	<th>開催日補足テキスト</th>
	<td>
		<?php echo h_br($event_date_text); ?>
	</td>
</tr><tr>
	<th>開催時間</th>
	<td>
		<?php echo h_br($event_time); ?>
	</td>
</tr><tr>
	<th>会場</th>
	<td>
		<?php echo h_br($event_place); ?>
	</td>
</tr><tr>
	<th>講師</th>
	<td>
		<?php echo h_br($instructor); ?>
	</td>
</tr><tr>
	<th>対象</th>
	<td>
		<?php echo h_br($target_person); ?>
	</td>
</tr>
	<!-- 追加項目セット位置 -->
</tbody>

...
<!--
	$(document).ready(function(){
		...
		$("#event_accept_end_date").datepicker();
	});
// -->
</SCRIPT>
<!-- //DatePickerを設定 -->
...
<tbody>
	...
	<tr>
		<th>年度</th>
		<td>
			<?php echo form_nds_dropdown('annual', $this->annual_list, $this->data); ?>
			<?php echo form_error('annual'); ?>
		</td>
	</tr>
</tbody>
</table>
...
<tbody>
	...
	<tr>
		...
		<td>
			<span class="label" style="vertical-align:baseline;">URL</span>　<?php echo form_nds_input('post_link', $this->data, 'class="span6" placeholder="" '); ?>
			<span class="help-block">URL形式で入力してください</span>
...
<tr>
	<th>リンク2</th>
	<td>
		<span class="label" style="vertical-align:baseline;">URL</span>　<?php echo form_nds_input('post_link2', $this->data, 'class="span6" placeholder="" '); ?>
		<span class="help-block">URL形式で入力してください</span>
		<?php echo form_error('post_link2'); ?>

		<span class="label" style="vertical-align:baseline;">リンク用テキスト</span>　<?php echo form_nds_input('post_link_text2', $this->data, 'class="span5" '); ?>
		<span class="help-block">リンクに使われる文字です。未入力の場合は規定値が使用されます。最大50文字</span>
		<?php echo form_error('post_link_text2'); ?>
	</td>
</tr>
<tr>
	<th>リンク3</th>
	<td>
		<span class="label" style="vertical-align:baseline;">URL</span>　<?php echo form_nds_input('post_link3', $this->data, 'class="span6" placeholder="" '); ?>
		<span class="help-block">URL形式で入力してください</span>
		<?php echo form_error('post_link3'); ?>

		<span class="label" style="vertical-align:baseline;">リンク用テキスト</span>　<?php echo form_nds_input('post_link_text3', $this->data, 'class="span5" '); ?>
		<span class="help-block">リンクに使われる文字です。未入力の場合は規定値が使用されます。最大50文字</span>
		<?php echo form_error('post_link_text3'); ?>
	</td>
</tr>
</tbody>
</table>
...
<thead>
	<tr>
		<th colspan="2" class="table_section">イベント情報</th>
	</tr>
</thead>
<tbody>
<tr>
	<th>募集有無</th>
	<td>
		<label class="checkbox"><?php echo form_nds_checkbox('event_accept_flg', Valid_flg::VALID, $this->data, ' class="" '); ?> 募集する</label>
		<?php echo form_error('event_accept_flg'); ?>
	</td>
</tr>
<tr>
	<th class="span3">申し込み締め切り日</th>
	<td>
		<?php echo form_nds_input('event_accept_end_date', $this->data, 'id="event_accept_end_date" class="" '); ?>
		<span class="help-block">※期限がない場合はブランクのままとしてください</span>
		<?php echo form_error('event_accept_end_date'); ?>
	</td>
</tr>
<tr>
	<th>申し込みフォーム</th>
	<td>
		<?php echo form_nds_dropdown('free_form_id', $this->free_form_list,  $this->data, ' class="span4" '); ?>
		<?php echo form_error('free_form_id'); ?>
	</td>
</tr>
<tr>
	<th>開催日</th>
	<td>
		<?php echo form_nds_input('event_start_date', $this->data, 'id="event_start_date" class="" '); ?>
...
<tr>
	<th>開催日補足テキスト</th>
	<td>
		<?php echo form_nds_textarea('event_date_text', $this->data, 'rows="3" class="span6" '); ?>
		<span class="help-block">未入力の場合は上の「開催日」で入力した日付がそのまま表示されます。</span>
		<?php echo form_error('event_date_text'); ?>
	</td>
</tr>
<tr>
	<th>開催時間</th>
	<td>
		<?php echo form_nds_textarea('event_time', $this->data, 'rows="3"  class="span6" '); ?>
...
<tr>
	<th>会場</th>
	<td>
		<?php echo form_nds_textarea('event_place', $this->data, 'rows="3"  class="span6" '); ?>
...
<tr>
	<th>講師</th>
	<td>
		<?php echo form_nds_input('instructor', $this->data, 'class="span6" '); ?>
...
<tr>
	<th>対象</th>
	<td>
		<?php echo form_nds_textarea('target_person', $this->data, 'rows="3"  class="span6" '); ?>
		<?php echo form_error('target_person'); ?>
	</td>
</tr>
	<!-- 追加項目セット位置 -->
</tbody>
...
<thead>
	<tr><th colspan="4" class="table_section">画像</th></tr>
</thead>

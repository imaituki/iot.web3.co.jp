...
<tr>
	...
	<td>
		<?php echo form_nds_dropdown('current_special_type', $this->special_category_list, $this->data, ' class="" '); ?>
		<?php echo form_error('current_special_type'); ?>
	</td>
</tr>

<tr>
	<th>特集の表示開始日　<span class="label label-warning">必須</span></th>
	<td>
		<?php echo form_nds_input('special_start_date', $this->data, ' id="special_start_date" class="" '); ?>
		<?php echo form_error('special_start_date'); ?>
	</td>
</tr>
<tr>
	<th>特集の表示終了日　<span class="label label-warning">必須</span></th>
	<td>
		<?php echo form_nds_input('special_end_date', $this->data, ' id="special_end_date" class="" '); ?>
		<?php echo form_error('special_end_date'); ?>
		<?php echo error_msg($this->error_list, 'special_end_date_reverse_date_error'); ?>
	</td>
</tr>

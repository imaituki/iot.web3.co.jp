...
<tbody>
	...
	<tr>
		...
		<td>
			<!-- 親子関係を持ったカテゴリーのラベルを出力する -->
			<?php if ( ! empty($this->parent_children_label_list)): ?>
			<?php foreach ($this->parent_children_label_list as $child_element): ?>
				<?php if ( ! empty($child_element['child_label_list'])): ?>
				<h5><?php echo h($child_element['parent_entity']->kubun_value); ?></h5>
				<p style="margin-left: 1em;">
				<?php echo implode(', ', $child_element['child_label_list']); ?>
				</p>
				<?php endif; ?>
			<?php endforeach; ?>
			<?php endif; ?>
	...
	<tr>
		...
		<td>
			<?php echo h(isset($this->order_number_list[$order_number]) ? $this->order_number_list[$order_number] : ''); ?>
		</td>
	</tr>
	<?php endif; ?>
	<tr>
		<th>技術評価</th>
		<td>
			<?php echo h($this->label_list['technology_ids']); ?>&nbsp;
		</td>
	</tr>
	<tr>
		<th>属性</th>
		<td>
			<?php echo h($this->label_list['other_attribute_ids']); ?>&nbsp;
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			<?php echo h($this->label_list['download_limited_kubun_ids']); ?>&nbsp;
		</td>
	</tr>
</tbody>
</table>
...
<tbody>
	...
	<tr>
		<th>関連する製品</th>
		<td><?php echo h($this->label_list['item_select']); ?></td>
	</tr>
</tbody>
</table>

...
// 作成日: 2019/12/28
// 作成者: 岡田
// 内  容： 実績紹介カテゴリマスタ操作クラス
//----------------------------------------------------------------------------

//-------------------------------------------------------
//  クラス
//-------------------------------------------------------
class AD_case_category {
	...
	function check( &$arrVal, $mode ) {
		...
		if( ( strcmp( $mode, "update" ) == 0 ) ) {
			$objInputCheck->entryData( "カテゴリID", "all", $arrVal["id_case_category"], array( "CHECK_EMPTY", "CHECK_NUM" ), null, null );
		}
	...
	function update( $arrVal, $arrSql = null ) {
		...
		// 更新条件
		$where = $this->_CtrTablePk . " = " . $arrVal["id_case_category"];
	...
	//-------------------------------------------------------
	// 関数名：delete
	// 引  数：$id - 削除する実績紹介カテゴリマスタID
	// 戻り値：true - 正常, false - 異常
	// 内  容：実績紹介カテゴリマスタデータ削除
	//-------------------------------------------------------
	function delete( $id ) {
	...
	//-------------------------------------------------------
	// 関数名：GetIdRow
	// 引  数：$id - 実績紹介カテゴリマスタID
	// 戻り値：実績紹介カテゴリマスタ
	// 内  容：実績紹介カテゴリマスタを1件取得する
	//-------------------------------------------------------
